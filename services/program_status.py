...
def _run_item(ctx: dict[str, Any], run: dict[str, Any], status: str) -> dict[str, Any]:
    ...
    return {
        ...
        "execution_mode": _first_present_body(run, ticket, "execution_mode") if ticket else body.get("execution_mode"),
        "ticket_created_at": ticket.get("body", {}).get("ticket_created_at") if ticket else None,
...
def _ticket_item(ctx: dict[str, Any], ticket: dict[str, Any], status: str) -> dict[str, Any]:
    ...
    return {
        ...
        "execution_mode": _first_present_body(latest_run, ticket, "execution_mode") or "implementation",
        "ticket_modified_at": _ticket_modified_at(ticket),
        "ticket_created_at": ticket.get("body", {}).get("ticket_created_at"),
