...
# Python services
for f in voice_bridge.py relay_completion_hook.py messenger.py command_actions.py pm_frontstage.py tts_worker.py tts_filter.py config.py voice_wrap.py preview_voice.py \
