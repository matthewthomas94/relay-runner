...
final class ProcessManagerLaunchTests: XCTestCase {
    ...
    func testEmbeddedLaunchScriptPassesEquivalentHiddenRelayInstructionsForCodexAndClaude() {
        ...
        for phrase in [
            ...
            "A newer command whose work_disposition is continue_current with authorization_effect preserve",
            "does not revoke the claimed item",
            "finish and reply only for the claimed item",
            "For every other newer command, stop stale work",
