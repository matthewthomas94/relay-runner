...
For wider behavioral guidelines such as the Karpathy rules, see `~/.claude/CLAUDE.md`; this repo's native Program Manager capture guidance overrides any older global PM-sync or project-ledger guidance.
