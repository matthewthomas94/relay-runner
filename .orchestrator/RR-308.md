...
worker_model: strong
worker_effort: high
worker_sizing_rationale: Cross-cutting AppKit and SwiftUI presentation work must reuse the animated particle renderer, route several modal and loading states, and preserve interaction and accessibility behavior.
