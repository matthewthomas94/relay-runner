---
id: RR-308
artifact_id: ticket-233f2b7065812a675a8468f0eec0c85b90a4691f
activity_at: 2026-08-10T11:34:26.479288Z
...
- **Run 30** (attempt 2) — branch `relay/rr-308`
  - Added a neutral full-bounds `ParticleFieldRenderer` theme and reused its multi-sine shimmer for clipped cold-load, refresh, and modal Workspace treatments with Reduce Motion timer suppression.
  - Layered the click-through matrix above subdued Workspace content and below ticket detail, create, edit, and spike-follow-up modals; the shared UI is provider-neutral and leaves STT/TTS themes and the compact Working glyph unchanged.
  - Added focused regression coverage; `git diff --check` passed and the full Swift suite passed 712 tests with 3 skips and 0 failures. No unresolved follow-ups; ticket done.
